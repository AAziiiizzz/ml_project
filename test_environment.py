from model_pipeline import (
    prepare_data, train_model, evaluate_model, predict,
    save_model, load_model, create_submission
)
...
# ----------------------------
submission = create_submission(predictions, data['test_ids'].head(), 'test_submission.csv')
